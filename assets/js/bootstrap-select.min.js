        ...
        var G = new RegExp(B + '|' + M),
            ...
            K = {
                ...
                label: function (e) {
                    ...
                    return (
                        e.subtext && (((t = _.subtext.cloneNode(!1)).textContent = e.subtext), s.appendChild(t)),
                        _.fragment.appendChild(s),
                        _.fragment
                    )
                },
            ...
            (Y.prototype = {
                ...
                buildList: function () {
                    ...
                    ;(!s.options.showTick && !s.multiple) ||
                        ...
                        ((_.checkMark.className = this.options.iconBase + ' ' + s.options.tickIcon + ' check-mark'),
                ...
                setSelected: function (e, t) {
                    ...
                    ;(o.selected = t),
                        ...
                        l
                            ? (this.focusItem(n, o), (this.selectpicker.view.currentActive = n), (this.activeIndex = e))
                            : this.defocusItem(n),
                        s &&
                ...
                changeAll: function (e) {
                    if (this.multiple) {
                        ...
                        t.classList.remove('bs-select-hidden'),
                            i !== s &&
                                (this.setOptionStatus(), (A = [null, null, n]), this.$element.triggerNative('change'))
                    }
                },
                selectAll: function () {
                                    ...
                                    e.which === B
                                        ? (-1 !== t && t--,
                                          ...
                                          a.selectpicker.view.canHighlight[t + f] ||
                                              (-1 ===
                                                  (t =
                                                      a.selectpicker.view.canHighlight.slice(0, t + f).lastIndexOf(!0) -
                                                      f) &&
                                                  (t = c.length - 1)))
                                        : (e.which !== M && !h) ||
                                          ...
                                          a.selectpicker.view.canHighlight[t + f] ||
                                              (t =
                                                  t +
                                                  1 +
                                                  a.selectpicker.view.canHighlight.slice(t + f + 1).indexOf(!0))),
                                    e.preventDefault()
                                var m = f + t
                                e.which === B
                                    ? 0 === f && t === c.length - 1
